...
mod tests {
    ...
    fn test_half_network() {
        ...
        assert!((half(&Algorithm::ContinuousOneplusoneNA(network)) - 1.).abs() < TOL);
    }
    ...
    fn test_quarter_network() {
        ...
        assert!((quarter(&Algorithm::ContinuousOneplusoneNA(network)) - 1.).abs() < TOL);
    }
    ...
    fn test_twoquarters_network() {
        ...
        assert!((two_quarters(&Algorithm::ContinuousOneplusoneNA(network)) - 1.).abs() < TOL);
    }
    ...
    fn test_half_vneuron_null_bias() {
        ...
        assert!((half(&Algorithm::ContinuousBNA(vneuron)) - 1.).abs() < TOL);
    }
    ...
    fn test_quarter_vneuron_oneplusonena_solution() {
        ...
        assert!((quarter(&Algorithm::ContinuousBNA(vneuron)) - 1.).abs() < TOL);
    }
    ...
    fn test_full_vneuron_null_bias() {
        ...
        assert!((full(&Algorithm::ContinuousBNA(vneuron)) - 1.).abs() < TOL);
    }
